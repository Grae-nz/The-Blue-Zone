      ...
      <div className="bg-black text-white p-2 flex flex-col md:flex-row items-center justify-between mb-12">
        <div className="md:w-1/2 space-y-4 md:pl-8">
          ...
          <h2
            ...
            style={{ fontFamily: "Montserrat, sans-serif" }}
          >
            For the latest prostate cancer news
          </h2>
          <h3
            className="text-base"
            style={{ fontFamily: "Open Sans, sans-serif" }}
          >
            Browse news, events, and real stories from people effected by
            prostate cancer.
          </h3>
        </div>
        <div className="md:w-1/2 mt-6 md:mt-0 aspect-[3/2] max-w-[700px] mx-auto">
          <img
            src="/images/newsstories.jpg"
        ...
        {categories.map((cat, idx) => (
          <a
            ...
            href={
              cat === "All"
                ? "/news-stories"
                : `/news-stories?category=${encodeURIComponent(cat)}`
            }
...
export default function News() {
  return (
    <Suspense fallback={<main className="p-8">Loading news…</main>}>
      <NewsContent />
    </Suspense>
  );
}
