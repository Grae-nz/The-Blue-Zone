...
function JustDiagnosedContent() {
  ...
  return (
    <main>
      ...
      <div className="bg-black text-white p-2 flex flex-col md:flex-row items-center justify-between mb-12">
        <div className="md:w-1/2 space-y-4 md:pl-8">
          ...
          <h2
            ...
            style={{ fontFamily: "Montserrat, sans-serif" }}
          >
            Find treatment options based on your stage
          </h2>
          <h3
            className="text-base"
            style={{ fontFamily: "Open Sans, sans-serif" }}
          >
            Choose a stage to learn what treatments may be suitable. Always
            speak with your healthcare provider for individual advice.
          </h3>
        </div>
        <div className="md:w-1/2 mt-6 md:mt-0 aspect-[3/2] max-w-[700px] mx-auto">
          <img
            src="/images/justdiagnosed.png"
            alt="Just Diagnosed"
      ...
      {/* Page content */}
      <div
        className="bg-white text-black max-w-6xl mx-auto px-4 py-12 space-y-16"
        style={{ fontFamily: "Open Sans, sans-serif" }}
      >
        {/* Category Buttons */}
        ...
        {category === "all" ? (
          content.map((section, idx) => (
            ...
            >
              <h2 className="text-xl font-bold text-[#0070C0]">
                {section.stage}
              </h2>
        ...
        {/* consult */}
        <p
          className="italic mt-6 text-gray-700 text-base text-center max-w-3xl mx-auto"
          style={{ fontFamily: "Open Sans, sans-serif" }}
        >
          For more detailed and personalized treatment options, it is essential
          to consult with a healthcare practitioner.
        </p>

        <section className="mt-12">
          <h2
            className="text-2xl text-[#0070C0] font-bold mb-4"
            style={{ fontFamily: "Open Sans, sans-serif" }}
          >
            Want to Learn More?
          </h2>
          <ul className="list-disc list-inside text-blue-600 underline">
            <li>
              <a href="#" target="_blank">
                Determining suitable Prostate cancer treatment options – Prostate
                Matters (PDF)
              </a>
            </li>
          </ul>
